...
We now transition to an analysis of the optimization of $f_{\theta}$. Our key result is Theorem \ref{theorem_1}. If we compare it against what we have in \eqref{lec14:eqn:g_exponential_decay}, we see the claimed similarity between $f_\theta$ and $g_\theta$ in error decay under optimization. 
