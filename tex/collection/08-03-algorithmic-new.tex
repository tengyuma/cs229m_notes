...
\sec{Implicit Regularization for Linear Models and Classifiers}
...
\subsec{Regularization by Initialization for Linear Models}
...
\sec{Noise Regularization of SGD}
...
\sec{SGD on non-quadratic functions}
