...
\sec{Deep neural nets (via data-dependent bounds)}\label{sec:deep_nets_data_dependent}
...
\subsec{Preparation: uniform convergence with a data-dependent hypothesis class}
...
\end{proof}
\sec{Comparisons and other remarks}
