...
\sec{Convergence to local minimum}
...
\begin{definition} [Strict-saddle condition (\cite{lee2016}; \cite{ge2015})]
...
\sec{Two examples where local minimums are global minimums}
